...
class Todo extends React.Component {
    ...
    componentDidMount() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.getDoneList();
        });
    }
    getTodoList() {
        return __awaiter(this, void 0, void 0, function* () {
            const ret = yield utils.get('/todo/getTodoList');
            console.log(ret);
            if (ret.status === 200) {
                this.setState({
                    toDoList: ret.data
    ...
    getDoneList() {
        return __awaiter(this, void 0, void 0, function* () {
            const ret = yield utils.get('/todo/getDoneList');
            if (ret.status === 200) {
                this.setState({
    ...
    addTask() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ret = yield utils.post('/todo/addTodoItem', toDoItem);
    ...
    delTodoItem(item) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deleteTodoItemRet = yield utils.post('/todo/deleteTodoItem', item);
    ...
    getTODOItems() {
        return this.state.toDoList.map((item, i) => {
            return (React.createElement("li", { key: item.id },
                ...
                React.createElement("button", { onClick: () => { this.setTaskDone(item); } }, "done"),
                React.createElement("button", { onClick: () => { this.delTodoItem(item); } }, "delete")));
        });
    }
    setTaskDone(item) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const setTaskDone = yield utils.post('/todo/setTaskDone', item);
    ...
    content() {
        return (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement("input", { value: this.state.taskVal, onChange: this.taskInput }),
                React.createElement("button", { onClick: this.addTask }, "add")),
            React.createElement("div", null,
                React.createElement("h3", null, "TODO"),
                React.createElement("ul", null, this.getTODOItems())),
            React.createElement("div", null,
                React.createElement("h3", null, "DONE"),
                React.createElement("ul", null, this.getDoneItems()))));
    }
    render() {
        return this.content();
    }
...
function addCsrfTokenToUrl(url) {
  return url += `${(url.indexOf('?') >= 0 ? '&' : '?')}_csrf=${__WEBPACK_IMPORTED_MODULE_1_js_cookie__["get"]('csrfToken')}`;
}
async function get(url) {
  return await __WEBPACK_IMPORTED_MODULE_0_axios__["get"](addCsrfTokenToUrl(url));
};

async function post(url, data) {
  return await __WEBPACK_IMPORTED_MODULE_0_axios__["post"](addCsrfTokenToUrl(url), data);
};
...
ReactDOM.render(React.createElement(todo_1.Todo, null), document.getElementById('todo'));
